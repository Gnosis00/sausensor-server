...
public final class findSensorsByArea_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_find_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_find_0.setZ("b/f1st00GJ207RIMWAq0P4BkR1Q=");
    _jspx_th_form_find_0.setPath("/sensors");
    _jspx_th_form_find_0.setId("ff_edu_sau_sausensor_server_domain_Sensor");
    _jspx_th_form_find_0.setFinderName("ByArea");
    _jspx_th_form_find_0.setJspBody(new findSensorsByArea_jspxHelper( 0, _jspx_page_context, _jspx_th_form_find_0, null));
  ...
  private boolean _jspx_meth_field_select_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_0.setZ("AiMlAd39NA4Ljol2+ulIrWYaBZA=");
    _jspx_th_field_select_0.setRequired(new Boolean(true));
    _jspx_th_field_select_0.setPath("/areas");
    _jspx_th_field_select_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${areas}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_0.setId("f_edu_sau_sausensor_server_domain_Sensor_area");
    _jspx_th_field_select_0.setField("area");
    _jspx_th_field_select_0.setDisableFormBinding(new Boolean(true));
    _jspx_th_field_select_0.doTag();
    return false;
  }

  private class findSensorsByArea_jspxHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    private javax.servlet.jsp.tagext.JspTag _jspx_parent;
    private int[] _jspx_push_body_count;

    public findSensorsByArea_jspxHelper( int discriminator, JspContext jspContext, javax.servlet.jsp.tagext.JspTag _jspx_parent, int[] _jspx_push_body_count ) {

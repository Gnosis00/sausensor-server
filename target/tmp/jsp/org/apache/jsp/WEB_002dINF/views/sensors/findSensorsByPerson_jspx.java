...
public final class findSensorsByPerson_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_find_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_find_0.setZ("NOIJ2QQAN4bk5DaiT+4B6wqVDbY=");
    _jspx_th_form_find_0.setPath("/sensors");
    _jspx_th_form_find_0.setId("ff_edu_sau_sausensor_server_domain_Sensor");
    _jspx_th_form_find_0.setFinderName("ByPerson");
    _jspx_th_form_find_0.setJspBody(new findSensorsByPerson_jspxHelper( 0, _jspx_page_context, _jspx_th_form_find_0, null));
  ...
  private boolean _jspx_meth_field_select_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_0.setZ("n/3ytJNQ1ZrWUzJoWB3pAA3FaYY=");
    _jspx_th_field_select_0.setRequired(new Boolean(true));
    _jspx_th_field_select_0.setPath("/people");
    _jspx_th_field_select_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${people}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_0.setItemValue("id");
    _jspx_th_field_select_0.setId("f_edu_sau_sausensor_server_domain_Sensor_person");
    _jspx_th_field_select_0.setField("person");
    _jspx_th_field_select_0.setDisableFormBinding(new Boolean(true));
    _jspx_th_field_select_0.doTag();
    return false;
  }

  private class findSensorsByPerson_jspxHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    private javax.servlet.jsp.tagext.JspTag _jspx_parent;
    private int[] _jspx_push_body_count;

    public findSensorsByPerson_jspxHelper( int discriminator, JspContext jspContext, javax.servlet.jsp.tagext.JspTag _jspx_parent, int[] _jspx_push_body_count ) {

...
public final class list_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_page_list_0(PageContext _jspx_page_context)
    ...
    _jspx_th_page_list_0.setZ("tFr7ziS5CPIN3d3UvE1z1hlT7fY=");
    _jspx_th_page_list_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sensors}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_page_list_0.setId("pl_edu_sau_sausensor_server_domain_Sensor");
  ...
  private boolean _jspx_meth_table_table_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_table_0.setZ("O6ramjX5UWO3/iGQIxf4IKE92tI=");
    _jspx_th_table_table_0.setPath("/sensors");
    _jspx_th_table_table_0.setId("l_edu_sau_sausensor_server_domain_Sensor");
    _jspx_th_table_table_0.setData((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sensors}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_table_column_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_0.setZ("dVYRHrKCorI/u4Ona+LDglDjeMs=");
    _jspx_th_table_column_0.setProperty("nodeid");
    _jspx_th_table_column_0.setId("c_edu_sau_sausensor_server_domain_Sensor_nodeid");
  ...
  private boolean _jspx_meth_table_column_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_1.setZ("LVLWjkpjUfiDHWcnOvkHqds+neo=");
    _jspx_th_table_column_1.setProperty("area");
    _jspx_th_table_column_1.setId("c_edu_sau_sausensor_server_domain_Sensor_area");
  ...
  private boolean _jspx_meth_table_column_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_2.setZ("42nNzPQmri2ISQWoQfB8zuQi8tM=");
    _jspx_th_table_column_2.setProperty("person");
    _jspx_th_table_column_2.setId("c_edu_sau_sausensor_server_domain_Sensor_person");
